...
const MyStack =() => {
    return (
      ...
      <Stack.Screen name="splashScreen" component={SplashScreen} />
            ...
            <Stack.Screen name="pickedUpOrderScreen" component={PickedUpOrdersScreen} />
            <Stack.Screen name="orderCompeletedScreen" component={OrderCompeletedScreen} />
            <Stack.Screen name="pickedUpAndDeliveryedScreen" component={PickUpAndDeliveredScreen} />
...
const AppTabsScreen = () => (
  ...
  <AppTabs.Screen options={{headerShown: false}} name="NewOrders" component={NewOrderStackScreen} />
  <AppTabs.Screen options={{headerShown: false}} name="Home" component={HomeStackScreen} />
  </AppTabs.Navigator>
)
